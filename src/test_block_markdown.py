...
"""
    ...
    def test_UL_blockTypeEquals(self):
        blk = "- This is a list\n- with items"
        self.assertEqual(block_to_block_type(blk), BlockType.UNORDERED_LIST)
    def test_OL_blockTypeEquals(self):
        blk = "1. This is a list with item"
        self.assertEqual(block_to_block_type(blk), BlockType.ORDERED_LIST)
    def test_UL_blockTypeEquals(self):
        blk = "> This is a block\n> quote"
        self.assertEqual(block_to_block_type(blk), BlockType.QUOTE)
    def test_CODE_blockTypeEquals(self):
        blk = "``` \nThis is a list with items\n ```"
        self.assertEqual(block_to_block_type(blk), BlockType.CODE)
    def test_P_blockTypeEquals(self):
        blk = "- This is a list\n with items"
        self.assertEqual(block_to_block_type(blk), BlockType.PARAGRAPH)
    def test_NotOL_blockTypeEquals(self):
        blk = "1. This is a list\n- with items"
        self.assertEqual(block_to_block_type(blk), BlockType.PARAGRAPH)
    def test_NotUL2_blockTypeEquals(self):
        blk = "1. This is a list\nwith items"
        self.assertEqual(block_to_block_type(blk), BlockType.PARAGRAPH)
    def test_Not3_blockTypeEquals(self):
        blk = "``` This is a list- with items```"
        self.assertEqual(block_to_block_type(blk), BlockType.PARAGRAPH)
    def test_Not4_blockTypeEquals(self):
        blk = "> This is a list\n- with items"
        self.assertEqual(block_to_block_type(blk), BlockType.PARAGRAPH)
